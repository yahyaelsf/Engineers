    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input name="s_address" type="text" class="form-control" value="{{ $engineer->s_address ?? '' }}" />
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-group">
                <label class="form-control-label"> نوع المساعدة</label>
                <input name="s_type" type="text" class="form-control" value="{{ $engineer->s_type ?? '' }}" />
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-group">
                <label class="form-control-label"> الجهة المانحة</label>
                <input name="s_donor" type="text" class="form-control" value="{{ $engineer->s_donor ?? '' }}" />
            </div>
        </div>
        {{-- <div class="col-md-4">
            <div class="form-group">
